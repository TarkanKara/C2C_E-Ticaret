    ...
    <div class="container">
        <div class="pagination-wrapper">
            <ul>
                ...
                <a href="kategoriler.php"><li>KATEGORİLER LİSTESİ</li></a>
            </ul>
        </div>
    </div>  
</div> 
                                ...
                                if (isset($_GET['kategori_id'])) {
                                    ...
                                    while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) { ?>
                                        ...
                                        <div class="single-item-list">
                                            <div class="item-img">
                                                <img style="width: 234px; height: 203px;" src="<?php echo $uruncek['urunfoto_resimyol'] ?>" alt="<?php echo $uruncek['urun_ad'] ?>" class="img-responsive">
                                            ...
                                            <div class="item-content">
                                                <div class="item-info">
                                                    ...
                                                    <div class="item-sale-info">
                                                        <div class="price"><?php echo $uruncek['urun_fiyat'] ?></div><span style="font-size:16px;"><b>TL</b></span>
                                        ...
                                        while ($s < $toplam_sayfa) {
                                            ...
                                            if (!empty($_GET['kategori_id'])) { 
                                                ...
                                                if ($s==$sayfa) {?>
                                                    ...
                                                    <li class="active"><a href="kategori-<?php echo $_GET['sef']; ?>-<?php echo $_GET['kategori_id'] ?>?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
