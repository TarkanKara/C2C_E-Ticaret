...
<footer>
    <div class="footer-area-top">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        ...
                        <ul class="corporate-address">
                            <li><i class="fa fa-map-marker" aria-hidden="true"></i><a href="Phone(01)800433633"><?php echo $ayarcek['ayar_adres'] ?></a></li>
                            <li><i class="fa fa-phone" aria-hidden="true"></i><?php echo $ayarcek['ayar_tel'] ?></li>
                            <li><i class="fa fa-fax" aria-hidden="true"></i><?php echo $ayarcek['ayar_faks'] ?></li>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        <h3 class="title-bar-left title-bar-footer">
                        ...
                        <ul class="featured-links">
                            <li>
                                <ul>
                                    ...
                                    <li><a href="#">Topluluk Buluşmaları</a></li>
                                    <li><a href="#">Üye Olunuz</a></li>
                                </ul>
                            </li>
                        </ul>                             
                    </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        <h3 class="title-bar-left title-bar-footer">Yardıma mı ihtiyacınız var?</h3>
                        <ul class="featured-links">
                            <li>
                                <ul>
                                    <li><a href="#">Yardım Merkezi</a></li>
                                    <li><a href="#">Foxtar Market Şartları</a></li>
                                    <li><a href="#">Yazar Koşulları</a></li>
                                    <li><a href="#">Foxtar Lisansları</a></li>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        <h3 class="title-bar-left title-bar-footer">Bizleri takip ediniz</h3>
                        ...
                        <div class="newsletter-area">
                            <h3>Bültene Abone Olunuz!</h3>
                            <div class="input-group stylish-input-group">
                                <input type="text" placeholder="E-posta adresinizi buraya girin" class="form-control">
    ...
    <div class="footer-area-bottom">
        <div class="container">
            <p> <b>@ 2021 <?php echo $ayarcek['ayar_author'] ?></b> tüm hakları saklıdır</p>
        </div>
    </div>
</footer>
